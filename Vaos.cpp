...
void BufferVoxelSet(VoxelSet& voxels, vec3 offset, vector<Vertex>& vertices) {
    int nextIdx = 0;
...
size_t MakeVaoGrid(VoxelSet& model, ivec3 dimensions, vec3 spacing, std::vector<GLuint>& vaos,
